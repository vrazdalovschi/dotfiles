...
# Constrained TypeVar with operations that preserve type
from numbers import Real
NumT = TypeVar('NumT', bound=Real)

def clamp(value: NumT, lower: NumT, upper: NumT) -> NumT:
...
def get_value(data: Mapping[str, T], key: str, default: T | object = MISSING) -> T:
    if key in data:
        return data[key]
